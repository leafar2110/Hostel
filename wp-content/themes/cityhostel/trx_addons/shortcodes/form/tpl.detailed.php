...
<div
	...
	class="sc_form sc_form_detailed<?php 
        ...
        if (!empty($args['form_contact'])) echo ' form_contact';
			...
			<div class="sc_form_info">
                ...
                if (!empty($args['address'])) {
                    ...
                    <div class="sc_form_info_item sc_form_info_item_address">
						...
						<span class="sc_form_info_area">
							<span class="sc_form_info_title"><?php esc_html_e('Address', 'cityhostel'); ?></span>
				...
				if (!empty($args['phone'])) {
					...
					<div class="sc_form_info_item sc_form_info_item_phone">
						<span class="sc_form_info_icon"></span>
						<span class="sc_form_info_area">
							<span class="sc_form_info_title"><?php esc_html_e('Phone', 'cityhostel'); ?></span>
							<span class="sc_form_info_data"><?php
								foreach ($args['phone'] as $item) {
									echo '<a href="tel:'.trim($item).'"><span>' . esc_html($item) . '</span></a>';
								}
							?></span>
						</span>
					</div>
				...
				if (!empty($args['email'])) {
					...
					<div class="sc_form_info_item sc_form_info_item_email">
						<span class="sc_form_info_icon"></span>
						<span class="sc_form_info_area">
							<span class="sc_form_info_title"><?php esc_html_e('E-mail', 'cityhostel'); ?></span>
						<span class="sc_form_info_data"><?php
    ...
    ?><div class="<?php echo esc_attr(trx_addons_get_column_class(1, 2)); ?>">
        <form class="sc_form_form <?php if ($form_style != 'default') echo 'sc_input_hover_'.esc_attr($form_style); ?>" method="post" action="<?php echo admin_url('admin-ajax.php'); ?>"><?php
            ...
            set_query_var('trx_addons_args_sc_form_field', array_merge($args, array(
                ...
                'field_placeholder' => esc_html__('Enter your name', 'cityhostel')
            ...
            set_query_var('trx_addons_args_sc_form_field', array_merge($args, array(
                ...
                'field_placeholder' => esc_html__('Enter your e-mail', 'cityhostel')
            ...
            set_query_var('trx_addons_args_sc_form_field', array_merge($args, array(
                ...
                'field_title' => esc_html__('Message', 'cityhostel'),
                'field_placeholder' => esc_html__('Enter your message', 'cityhostel')
            ...
            ?><div class="sc_form_field sc_form_field_button sc_form_field_submit"><?php
                ...
                ?>><?php
                    if (!empty($args['button_caption']))
                        ...
                        esc_html_e('Send Message', 'cityhostel');
                    ?></button>
            </div>
