...
jQuery(document).on('action.init_hidden_elements', function(e, cont) {
	"use strict";
	if (CITYHOSTEL_STORAGE['button_hover'] && CITYHOSTEL_STORAGE['button_hover']!='default') {
		jQuery('button:not(.search_submit):not([class*="sc_button_hover_"]),\
				...
				.cityhostel_tabs .cityhostel_tabs_titles li a:not([class*="sc_button_hover_"]),\
				...
				').addClass('sc_button_hover_just_init sc_button_hover_'+CITYHOSTEL_STORAGE['button_hover']);
		if (CITYHOSTEL_STORAGE['button_hover']!='arrow') {
			jQuery('input[type="submit"]:not([class*="sc_button_hover_"]),\
					input[type="button"]:not([class*="sc_button_hover_"]),\
					.vc_tta-accordion .vc_tta-panel-heading .vc_tta-panel-title:not([class*="sc_button_hover_"]),\
		...
		jQuery('.trx_addons_hover_content .trx_addons_hover_links a:not([class*="sc_button_hover_style_"]),\
   				.vc_tta-accordion .vc_tta-panel-heading .vc_tta-panel-title:not([class*="sc_button_hover_style_"]),\
		...
		jQuery(' .vc_tta.vc_tta-color-grey.vc_tta-style-classic .vc_tta-tab > a\
				').addClass('sc_button_hover_just_init sc_button_hover_style_alter');
		jQuery('.sidebar .trx_addons_tabs .trx_addons_tabs_titles li a:not([class*="sc_button_hover_style_"]),\
				.cityhostel_tabs .cityhostel_tabs_titles li a:not([class*="sc_button_hover_style_"])\
				').addClass('sc_button_hover_just_init sc_button_hover_style_alterbd');
        jQuery('.widget_tag_cloud a:not([class*="sc_button_hover_style_"]),\
				.widget_product_tag_cloud a:not([class*="sc_button_hover_style_"])\
				').addClass('sc_button_hover_just_init sc_button_bordered');
		...
		jQuery('.mejs-controls button,\
				...
				').removeClass('sc_button_hover_'+CITYHOSTEL_STORAGE['button_hover']);
